...
@myquestioner.route('/meetups', methods=['POST'])
def post_meetup():
...
@myquestioner.route('/meetups/<int:meetupId>', methods=['GET'])
...
@myquestioner.route('/meetups/upcoming', methods=['GET'])
...
@myquestioner.route('/meetups/<int:meetupId>/questions', methods=['POST'])
...
@myquestioner.route('/meetups/<int:meetupId>/rsvps', methods=['POST'])
...
@myquestioner.route('/questions/<int:questionId>/upvote', methods=['PATCH'])
...
@myquestioner.route('/questions/<int:questionId>/downvote', methods=['PATCH'])
